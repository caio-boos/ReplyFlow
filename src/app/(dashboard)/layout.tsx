          ...
          <div className="max-w-3xl mx-auto px-6 py-8 space-y-10">
            ...
            <section>
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Escolha o tema da interface</p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${theme === "dark" ? "bg-indigo-500/20" : "bg-white/5"}`}>
                    <svg className={`w-5 h-5 ${theme === "dark" ? "text-indigo-300" : "text-gray-500"}`} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className={`text-sm font-medium leading-tight ${theme === "dark" ? "text-white" : "text-gray-400"}`}>Modo escuro</p>
                    <p className="text-xs text-gray-600 mt-0.5">Interface com fundo escuro</p>
                  </div>
                  {theme === "dark" && (
                ...
                >
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${theme === "light" ? "bg-indigo-500/20" : "bg-white/5"}`}>
                    <svg className={`w-5 h-5 ${theme === "light" ? "text-indigo-300" : "text-gray-500"}`} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM18.894 6.166a.75.75 0 00-1.06-1.06l-1.591 1.59a.75.75 0 101.06 1.061l1.591-1.59zM21.75 12a.75.75 0 01-.75.75h-2.25a.75.75 0 010-1.5H21a.75.75 0 01.75.75zM17.834 18.894a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 10-1.061 1.06l1.59 1.591zM12 18a.75.75 0 01.75.75V21a.75.75 0 01-1.5 0v-2.25A.75.75 0 0112 18zM7.758 17.303a.75.75 0 00-1.061-1.06l-1.591 1.59a.75.75 0 001.06 1.061l1.591-1.59zM6 12a.75.75 0 01-.75.75H3a.75.75 0 010-1.5h2.25A.75.75 0 016 12zM6.697 7.757a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 00-1.061 1.06l1.59 1.591z" />
                    </svg>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className={`text-sm font-medium leading-tight ${theme === "light" ? "text-white" : "text-gray-400"}`}>Modo claro</p>
                    <p className="text-xs text-gray-600 mt-0.5">Interface com fundo claro</p>
                  </div>
                  {theme === "light" && (
                    <svg className="w-4 h-4 text-indigo-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4.5 12.75l6 6 9-13.5" />
                ...
                {accounts.length === 0 ? (
                  <div className="border-2 border-dashed border-white/10 rounded-2xl p-10 text-center">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#96BF48]/10 border border-[#96BF48]/20 flex items-center justify-center">
                      <Image src="/images/shopify-logo.png" alt="Shopify" width={40} height={12} className="opacity-70" style={{ height: "auto" }} unoptimized />
                    </div>
                  ...
                  <>
                    {accounts.map((account) => (
                      <div key={account.id} className="flex items-center gap-4 p-4 bg-white/3 border border-white/6 rounded-xl hover:bg-white/5 transition-colors">
            ...
            <section>
              ...
              <Link href="/context" onClick={onClose} className="flex items-center gap-4 p-4 bg-white/3 border border-white/6 rounded-xl hover:bg-white/5 transition-colors group">
            ...
            <section>
              ...
              <Link href="/remarketing" onClick={onClose} className="flex items-center gap-4 p-4 bg-white/3 border border-white/6 rounded-xl hover:bg-white/5 transition-colors group">
  ...
  return (
    <>
      <div className="flex h-screen overflow-hidden bg-gray-950">
        ...
        {/* Main content */}
        <main className="flex-1 h-full overflow-y-auto bg-gray-950">{children}</main>
      </div>
