      ...
      <aside className="w-60 flex flex-col shrink-0 border-r border-white/6 bg-gray-900/60">
        ...
        <div className="p-3 border-t border-white/6">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-300 hover:bg-white/5 transition-all duration-150"
          >
            <svg
              className="w-4 h-4"
              fill="none"
